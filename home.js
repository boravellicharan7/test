...
playPauseBtn.addEventListener("click", () => {
    if (audio.paused) {
        audio.play();
        playPauseBtn.innerHTML = `<img src="./images/Untitled design (2).png" alt="" style="width: 40px; border-radius: 50%;">`
    } else {
        audio.pause();
        playPauseBtn.innerHTML = `<img src="./images/Untitled design (3).png" alt="" style="width: 40px; border-radius: 50%;">`
    }
});
